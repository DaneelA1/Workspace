package tutorialPag;
	...
	import java.util.ArrayList; // It imports ArrayList

	import java.util.Scanner; // It imports scanner
	
	import java.util.Random; // It imports random


public class PythonJavaGameConversion {
	...
	// public static voidines gun room inside
	  ...
	  // else if the choice is equal to 2 continue
	    ...
	    // If sleeps the program for 3 seconds
	    System.out.println ("You die sorry.");
	    // System.out.printlns "You die sorry."
	    
	    
	    gunroominside();
	    // This calls the function gunroominside(); to continue to it
	  }
	  else {
	  // If anything else is written other than 1 or 2 continue
	    ...
	    // This sleeps the program for 2 seconds
	    gunroominside();
	    // This calls the function gunroominside(); to go back to it
	  }}}
	public static void Fightnumber1() {
	// A public static void Fightnumber1 with no parameters
	  ...
	  // This creates a variable choice and asks the user "Enter 1 to shoot in the head or 2 in the chest " 
	  if (choice == 1) {
	  // If the choice is equal to 1 continue
	...
	// A public static void function Endgame();
	  System.out.println ("Congratulations!");
	  // System.out.printlns "Congratulations!"
	  ...
	  // This creates the variable choice and System.out.printlns "Enter 1 to play again or 2 to End."
	  if (choice == 1) {
	  // If the user choice is equal to 1 continue
	    ...
	    // It sleeps the program for 2 seconds
	    YourRoom(); // This calls the function YourRoom(); to go to it
	  ...
	  // If user choice is anything other than 1 or 2 continue
	    ...
	    Endgame(); // This calls the function Endgame(); to go to it.
	...
	public static void main(String[] args) {
		...
		System.out.println ("This game will be based on your choices."); // System.out.printlns "This game will be based on your choices."
		System.out.println ("Choose Wisely."); // System.out.printlns "Choose Wisely."
		YourRoom(); // This will call the function YourRoom(); which ultimately starts the whole game
