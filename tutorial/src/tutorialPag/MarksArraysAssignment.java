...
public class MarksArraysAssignment {

	public static void main(String[] args) { // Runs everything in the code
		String[] NameArray = {"Marc","Greg","Lebron","Kobe","Michael","Sam"}; //array of names
		...
		for(int i = 0; i < NameArray.length; i++) { //prints all students names, grades, and exam marks
			System.out.println(NameArray[i] + " " + gradeNum[i] + " " + exam1[i] + " " + exam2[i] + " " + exam3[i]); // Prints the student's name, grade, and their exam grade from exams 1-3
		}//end for
